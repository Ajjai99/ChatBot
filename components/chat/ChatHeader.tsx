    ...
    <div className="bg-[#0046ff] text-white p-4 rounded-t-2xl flex justify-between items-center shadow-md">
        <div className="flex items-center space-x-3 flex-1 min-w-0">
            <div className="relative">
                ...
                />
                <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-green-400 border-2 border-[#0046ff]"></span>
            </div>
            {isSearchOpen ? (
        ...
        <div className="flex items-center space-x-2 pl-2">
            <button onClick={onSearchToggle} className="p-2 hover:bg-white/20 rounded-full transition-colors">
